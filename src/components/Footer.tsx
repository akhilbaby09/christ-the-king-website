        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-12">
          ...
          <div>
            ...
            <ul className="space-y-3">
              {["Home", "About Us", "Our Mission", "Parish Forms", "Contact"].map((link) => (
                <li key={link}>
                  <a
          ...
          <div>
            ...
            <div className="flex gap-4 mb-8">
              <a
                href="#"
                className="w-10 h-10 rounded-full bg-cream/10 flex items-center justify-center hover:bg-gold hover:text-brown transition-colors"
                aria-label="Facebook"
              >
